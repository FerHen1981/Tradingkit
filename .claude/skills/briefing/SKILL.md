---
name: briefing
description: Produceer een cross-domain briefing over MEX Traders én de rest van LifeOS (familie, gezondheid, financiën, huis, admin, ontwikkeling, lifestyle, governance). Gebruik dit bij vragen als "geef me de briefing", "wat botst deze week", "wat wacht op mij", "waar zit ik op capaciteit", "toon me een LifeOS-breed overzicht". Werkt vanuit de MEX Scrum Master (start bij het MEX-bord) EN vanuit de LifeOS Chief of Staff (start bij LifeOS Tasks). Levert dezelfde output-structuur ongeacht wie 'm aanroept — één pagina die Ferry alleen hoeft te lezen om zijn week te overzien.
---
...
Deze skill is de dunne laag die dat gat dicht zónder een derde rol te introduceren.
Elke agent kan hem draaien; de output is gelijk. Geen governance-tussenlaag, geen
authority, geen dagelijkse aanwezigheid — enkel een leesbeurt die eindigt in één
pagina naar Ferry.
...
Als jij de Chief of Staff bent en geen `docs/SPRINT.md` kunt lezen, vraag het MEX-
bord aan de Scrum Master. Andersom: als jij de Scrum Master bent en geen LifeOS
Tasks kunt lezen, vraag het aan de Chief of Staff. Nooit gokken; nooit een
domein-conclusie trekken zonder de bron.
