...
| **D-46** | wip | Pine Dev | **Exit-engine test: de trail uit.** De chronologische payout-simulatie op de drie exports (q3 T10/B100/DLL150, venster 18-23) geeft **nul payouts** in alle negen combinaties: hoogste balans ooit $50.419 tegen $52.600 nodig voor payout 1, dus de ladder kwam nooit in beeld en het accounttype maakte niets uit. Oorzaak is de exit-verdeling, niet de account-regels: **662 van de 790 exits zijn TRAIL**. Met activatie 48 / buffer 24 wordt de gemiddelde winnaar op ~$61 afgekapt terwijl de stop op 100 ticks blijft staan — win/loss 0,4 bij 66% hitrate is structureel negatief. Test: **Enable Trailing = Off**, alle overige inputs identiek aan de gevalideerde run, zodat 1,55R de winnaar mag uitlopen. Run B zet daarnaast de break-even uit om die tweede afkapper te isoleren. Wat de simulatie wél aantoonde: de risk-gate verlengt de overleving van 17 -> 59 -> 157 dagen, en *cuts-the-trade* wint daarmee van *realized-only*. |
