...
`tests/test_mex_units_roles.py` loopt de geserialiseerde viewer- en publieke
payloads na en faalt op elke sleutel of waarde die naar geld ruikt.
...
(werkafspraken §3); die koppeling hoort in `public_stats.py`, niet hier.
"""
